	...
	<nav>
		<div class="nav__content">
			...
			<ul>
				...
				<li><a href="./apropos.php">ℹ️ A propos</a></li>
		...
		<div class="section__container">
			...
			<div class="content">
				...
				<div class="action__btns">
					<button class="hire__me" data-bs-toggle="modal" data-bs-target="#historiqueModal"><i class="bi bi-clock-history"></i> Historique</button>
					<button class="a" id="list"><i class="bi bi-eye-fill"></i> Voir la liste</button>
				</div>
